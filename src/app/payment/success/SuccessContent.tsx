  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-2xl">
      <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-2">Pesanan Anda telah dibayar dan sedang diproses.</p>
        <p className="text-sm text-gray-500 mb-6">Kami akan segera mengirimkan konfirmasi via WhatsApp/Email.</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg text-white font-medium transition-all hover:opacity-90" style={{ backgroundColor: '#c4367b' }}>
            <Home className="w-4 h-4" /> Kembali ke Home
          </Link>
          <Link href={detailPath} className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg border-2 font-medium transition-all hover:bg-gray-50" style={{ borderColor: '#c4367b', color: '#c4367b' }}>
            <ShoppingBag className="w-4 h-4" /> {isBooking ? 'Lihat Layanan' : 'Belanja Lagi'}
          </Link>
        </div>
